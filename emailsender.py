...
#You can turn off access for these apps, which I recommend,
...
#So before you run this code
# go to your Google Account and turn on 'Allow less secure apps'

#this code allows you to send emails from a tkinter window
